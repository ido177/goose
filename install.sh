...
if [ $# -eq 0 ]; then
	goose_uri="https://github.com/ido177/goose/releases/latest/download/goose_${os}_${arch}"
else
	goose_uri="https://github.com/ido177/goose/releases/download/${1}/goose_${os}_${arch}"
fi
